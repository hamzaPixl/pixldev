        ...
        {caseStudies.length === 0 ? (
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {caseStudies.map((caseStudy) => (
              ...
              >
                <Card className="border-border/20 hover:border-pixl-teal/30 transition-all duration-300 overflow-hidden cursor-pointer h-full">
                  {/* Featured image */}
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex items-center justify-between pt-2">
                      ...
                      <ArrowRight className="h-4 w-4 text-pixl-teal transition-transform group-hover:translate-x-1" />
                    </div>
                  </CardContent>
                </Card>
              </Link>
