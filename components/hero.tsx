      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <div className="opacity-0 animate-[fadeInUp_0.8s_ease-out_1s_forwards]">
          <Button
            ...
            className="bg-pixl-teal hover:bg-pixl-teal/90 text-black font-semibold px-8 py-6 text-lg rounded-full transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-pixl-teal/25 group"
          >
