              ...
              {posts.map((post, index) => {
                ...
                return (
                  <Link key={post.slug} href={`/blog/${post.slug}`}>
                    <article
                      className={cn(
                        "group border border-border bg-card p-5 sm:p-6 transition-all cursor-pointer",
                    ...
                    >
                      <div className="flex gap-4 sm:gap-5 items-start">
                        {/* Icon */}
                        <div className="shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-md border border-border bg-background flex items-center justify-center group-hover:border-primary/40 transition-colors">
